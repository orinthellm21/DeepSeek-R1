...
We’ve noticed that DeepSeek-R1 series models occasionally skip the expected thinking pattern (i.e., outputting <think>\n\n</think>) in response to certain queries, which can negatively impact performance.
